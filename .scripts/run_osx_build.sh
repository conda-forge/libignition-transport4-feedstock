...
validate_recipe_outputs "libignition-transport4-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="libignition-transport4-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi